...
export default function NavBar(){  
    ...
    return (
        <nav className={`
            min-w-full fixed z-[1000] top-0 left-0 h-[60px] md:h-auto  ${showmobilemenu ? 'md:bg-transparent bg-black':''} 
            flex flex-col md:flex-row md:px-[2rem] xl:px-[7rem] md:py-4 justify-between
            text-white ${scrolldistancereached ? 'bg-black py-[8px] md:py-[5px] duration-300':''}
        `}>
            <header className={`self-center grow flex items-center w-full px-4 md:w-auto md:px-0 md:block justify-between`}>
                <Image alt="Blacvolta logo" className="aspect-[4/3] object-contain md:h-auto md:w-auto" width={60} height={60}  src="/assets/images/logo.png" priority />
